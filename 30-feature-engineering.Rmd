...
I think that gross income per item is a good index to predict the item quantities. Thus, I want to create a new variable called gross_income_per_item to reflect this information. It can be caculated by: total gross income / quantity.
